...
function opengallery() {
    ...
    /*    האם אני צריכה כי גם הCSS עושה את הפעולה של ההסתרה פה זה רק מוודא שאין משהו פעיל*/
   /*לא רלוונטי בקוד הספציפי שלנו כי הגדרנו שכולם שכל התמונות יהיו עם אופסיטי אבל אם תהיה תמונה שלא תהיה עם עיצוב התחלתי בשקיפות אז הלולאה תשנה לה את השקיפות */
